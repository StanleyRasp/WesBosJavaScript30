...
const sortedByYearsLived = inventors.sort((a, b) => {
    const aTotalYears = a.passed - a.year;
    const bTotalYears = b.passed - b.year;
    if (aTotalYears >= bTotalYears) return 1;
    return -1;
})

// 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
filteredBoulevardNames = [ 
    "Boulevard de l'Amiral-Bruix", "Boulevard des Capucines", 
    "Boulevard de la Chapelle", "Boulevard de Clichy", 
    "Boulevard de l'Hôpital", "Boulevard des Italiens", 
    "Boulevard de la Madeleine", "Boulevard de Magenta", 
